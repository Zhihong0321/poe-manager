...
export function parsePrice(note) {
    if (!note)
...
function bucketItems(items) {
    const groups = {
        g1: { label: '0 ~ 100 Chaos', items: [], color: '#94a3b8', currency: 'chaos', min: 0, max: 100 },
        g2: { label: '100 ~ 300 Chaos', items: [], color: '#cbd5e1', currency: 'chaos', min: 101, max: 300 },
        g3: { label: '300 ~ 800 Chaos', items: [], color: '#e2e8f0', currency: 'chaos', min: 301, max: 800 },
        gEx1: { label: '0 ~ 20 Exalted', items: [], color: '#fdba74', currency: 'ex', min: 0, max: 20 },
        gEx2: { label: '20 ~ 100 Exalted', items: [], color: '#fb923c', currency: 'ex', min: 21, max: 100 },
        gEx3: { label: '100 ~ 200 Exalted', items: [], color: '#ea580c', currency: 'ex', min: 101, max: 200 },
        gEx4: { label: '200+ Exalted', items: [], color: '#991b1b', currency: 'ex', min: 201, max: undefined },
        g4: { label: '1D ~ 2D', items: [], color: '#facc15', currency: 'd', min: 0, max: 2.9 },
        g5: { label: '3D ~ 5D', items: [], color: '#f59e0b', currency: 'd', min: 3, max: 5 },
        g6: { label: '6D ~ 10D', items: [], color: '#d97706', currency: 'd', min: 6, max: 10 },
        g7: { label: '11D ~ 25D', items: [], color: '#b45309', currency: 'd', min: 11, max: 25 },
        g8: { label: '26D and above', items: [], color: '#ef4444', currency: 'd', min: 26, max: undefined },
        g9: { label: 'Unpriced / Other', items: [], color: '#64748b', currency: 'unknown', min: undefined, max: undefined }
    };
    items.forEach(s => {
